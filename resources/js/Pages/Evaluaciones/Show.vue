        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto px-4 lg:px-8">
                <div class="my-6">
                    ...
                    <div class="bg-white border border-gray-200 p-3 text-lg">
                        <span class="font-semibold">Comienzo</span>:
                        <span>{{ evaluacion.fechaHoraComienzo }}</span>
                    </div>
                ...
                <div class="my-6">
                    ...
                    <div v-for="archivo in evaluacion.archivos" :key="archivo.id" 
                        ...
                        <a :href="'storage/app/public/Evaluaciones/' + archivo.archivo" target="_blank" rel="noopener noreferrer">
                            {{ archivo.archivo }}
                        </a>
                    </div>
                </div>
